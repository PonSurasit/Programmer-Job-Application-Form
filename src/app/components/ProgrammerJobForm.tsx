...
const JobApplicationForm = () => {
  ...
  const handleChange = (
    ...
    if (name === 'expectedSalary') {
      // อนุญาตให้ใส่ได้เฉพาะตัวเลขและลูกน้ำ
      ...
      // ถ้าเป็นการกรอกข้อมูลในฟอร์มหลัก
      setFormData(prev => ({
        ...prev,
        [name]: value
      }));
                  ...
                  {formData.programmingSkills.includes('อื่นๆ') && (
                    <div className="col-span-2 mt-2">
                      <input
                        ...
                        value={editingData.otherProgrammingSkill}
                        onChange={handleChange}
                        className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2"
                  ...
                  {formData.frameworks.includes('อื่นๆ') && (
                    <div className="col-span-2 mt-2">
                      <input
                        type="text"
                        name="otherFramework"
                        value={editingData.otherFramework}
                        onChange={handleChange}
                        className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2"
                  ...
                  {formData.languages.includes('อื่นๆ') && (
                    <div className="col-span-2 mt-2">
                      <input
                        type="text"
                        name="otherLanguage"
                        value={editingData.otherLanguage}
                        onChange={handleChange}
                        className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2"
                ...
                <>
                  ...
                  {formData.experience === 'มี' && (
                    <textarea
                      ...
                      value={editingData.experienceDetails}
                      onChange={handleChange}
                      rows={4}
            ...
            <div>
              ...
              {isEditing ? (
                <input
                  type="text"
                  name="expectedSalary"
                  value={editingData.expectedSalary}
                  onChange={handleChange}
                  className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2"
                />
              ) : (
