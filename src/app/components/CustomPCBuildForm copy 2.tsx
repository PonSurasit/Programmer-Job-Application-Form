...
const JobApplicationForm = () => {
  ...
  const handleChange = (
    ...
    if (name === 'expectedSalary') {
      ...
      // เพิ่มเงื่อนไขสำหรับโหมดแก้ไข
      setFormData(prev => ({
        ...prev,
        [name]: value
      }));
      
      // อัพเดท submittedFormData ด้วย
  ...
  const handleSaveEdit = () => {
    ...
    // อัพเดทข้อมูลทั้ง formData และ submittedFormData
                  ...
                  onClick={() => {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        setIsEditing(false);
                        // รีเซ็ต formData กลับไปเป็นค่าเดิมจาก submittedFormData
